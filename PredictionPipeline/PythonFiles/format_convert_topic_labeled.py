...
# 		Tweet Id,Tweetwords,Content Topic  
#
#  USAGE: format_convert_topic.py 
# 
# 
#
...
wekafilename="InputFiles/topic_labeled"
...
wekafile.write("@attribute classlabel {lack_of_law,lack_of_services,society_belief,domestic_violence,third_party_account,news,self_belief,personal_account} \n")
wekafile.write("\n")
wekafile.write("@data")
wekafile.write("\n")
...
for line in open(file1):
	...
	#classlabel_style=str(tokens[5])
		...
		classlabel_topic=classlabel_topic.replace(" ","_")
		classlabel_topic=classlabel_topic.lower()
		
		wekafile.write("\"" + str(classlabel_topic) + "\"" ) 
...
print ('\n------ Converted Content_Theme Labels to Arff Format -----\n')
