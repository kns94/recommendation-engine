...
# 		Tweet Id,Tweetwords,Content Theme  
#
#  USAGE: format_convert_theme.py 
# 
# 
#
...
wekafilename="InputFiles/theme_labeled"
...
wekafile.write("@attribute classlabel {sexual_violence,physical_violence,harmful_practices,other} \n")
wekafile.write("\n")
wekafile.write("@data")
wekafile.write("\n")
...
for line in open(file1):
	...
	#classlabel_style=str(tokens[5])
		...
		classlabel_theme=classlabel_theme.replace(" ","_")
		classlabel_theme=classlabel_theme.lower()
	#	
		wekafile.write("\"" + str(classlabel_theme) + "\"" ) 
